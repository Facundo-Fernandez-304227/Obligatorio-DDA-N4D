...
public class Notificacion {
    ...
    // GETTER PARA JSON Y DTO PARA QUE NO ROMPA CON LOCALDATETIME POR LA
    // SERIALIZACION
    // (SINO HAY QUE IMPORTAR JACKSON PARA JAVA 8 E IMPORTARLO EN EL SERIALIZADOR
    // DEL CONEXION NAVEGADOR)
